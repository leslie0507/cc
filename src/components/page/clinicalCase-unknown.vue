			...
			<div class="main-content-wrapper">
				...
				<div class="params-wrapper">
					...
					<div class="params-item">
						...
						<button class="el-btn el-btn-unknown-actived">未知</button>
					</div>
					<!-- 一条 -->
					<div class="params-item">
						<div class="text">脑梗塞</div>
						<div class="fill-box">
							<button class="el-btn  el-btn-wu">无</button>
					...
					<div class="params-item last-item">
						...
						<div class="fill-box">
							<div class="input-box">
								<input type="text" class="el-input el-input-lg last-input" placeholder="">
...
<style lang="scss" scoped>
	...
	//最后一个input加绿色border
	.last-input{
		border:1px solid rgba(105, 202, 142, 1) !important;
	}
			...
			.main-content-wrapper {
				...
				.params-wrapper {
					...
					.params-item {
						...
						.el-btn-unknown-actived{
							width: 64px;
							height: 38px;
							color: #FFFFFF;
							background: url(../../assets/icons/btn-un-actived.png) no-repeat;
							background-size: cover;
							border-radius: 0px;
						}
